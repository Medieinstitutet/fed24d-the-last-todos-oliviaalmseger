    ...
    <div>
        <form onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col items-center gap-2 bg-white">
                ...
                <button className="bg-[#004aad] text-white px-4 py-2 mt-1.5 text-s border border-[#004aad] rounded hover:bg-[#3a69a7] transition-colors duration-200">Lägg till</button>
            </div>
        </form>
    </div>
    </>
